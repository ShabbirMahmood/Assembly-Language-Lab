;Shabbir Mahmood ID: 14015139 Assembly Language Lab Problem-3b(Character String Sorting Ascending Order)  Date: 18-03-2017
.MODEL SMALL
.STACK 100H
.DATA
      LF EQU 0AH
      ...
      MSG2 DB CR,LF,'Sorted(Ascending Order)Output String is: $'
      N DW ?
